...
<body>
	...
	<div class="container col-md-4 mt-4 p-5"" style="background-color:#535d8b;">
		
	
		<center>
            <h2 style="margin-bottom:45px!important; color:white;">Login Form</h2>
        </center>
		...
		<form  action="validateUser" method="post">
            ...
            <br>
            <div class="col-md-12">
            	<center><button type="submit" class="btn btn-light mb-3">Login</button></center>
            </div>

			<center><span><p style="color:white;">New User</p></span> <a href="register">Register</a></center>
